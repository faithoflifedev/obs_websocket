...
class ObsSetVideoSettingsCommand extends ObsHelperCommand {
  ...
  void run() async {
    ...
    await obs.config.setVideoSettings(VideoSettings(
...
class ObsGetStreamServiceSettingsCommand extends ObsHelperCommand {
  ...
  void run() async {
    ...
    final streamServiceSettingsResponse =
        await obs.config.getStreamServiceSettings();
