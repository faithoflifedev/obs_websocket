...
void main() {
  ...
  test('CallVendorRequest', () async {
    ...
    final callVendorRequestResponse =
        CallVendorRequestResponse.fromJson(requestResponse.responseData!);
  ...
  test('GetHotkeyList', () async {
    ...
    final hotkeys =
        StringListResponse.fromJson(requestResponse.responseData!).items;
