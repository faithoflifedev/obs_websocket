...
void main() {
  test('GetInputList', () async {
    ...
    final inputKindResponse =
        InputKindResponse.fromJson(requestResponse.responseData!);
  ...
  test('GetInputKindList', () async {
    ...
    final inputKindResponse =
        StringListResponse.fromJson(requestResponse.responseData!);
  ...
  test('GetSpecialInputs', () async {
    ...
    final specialInputsResponse =
        SpecialInputsResponse.fromJson(requestResponse.responseData!);
  ...
  test('CreateInput', () async {
    ...
    final createInputResponse =
        CreateInputResponse.fromJson(requestResponse.responseData!);

    expect(opcode.op, 7);
    expect(requestResponse.requestType, 'CreateInput');
    expect(requestResponse.requestStatus.code, 100);
    expect(
        createInputResponse.inputUuid, '01834b13-975e-4a9d-a42f-8680568ad83d');
  });
  ...
  test('GetInputDefaultSettings', () async {
    ...
    final inputDefaultSettingsResponse =
        InputDefaultSettingsResponse.fromJson(requestResponse.responseData!);

    expect(opcode.op, 7);
    expect(requestResponse.requestType, 'GetInputDefaultSettings');
    expect(requestResponse.requestStatus.code, 100);
    expect(inputDefaultSettingsResponse.defaultInputSettings,
  ...
  test('GetInputSettings', () async {
    ...
    final inputSettingsResponse =
        InputSettingsResponse.fromJson(requestResponse.responseData!);
  ...
  test('GetInputMute', () async {
    ...
    final booleanResponse =
        BooleanResponse.fromJson(requestResponse.responseData!);
